...
describe('filesystem.js', function() {
  ...
  describe('.removeFile', function() {
    it('returns promise', function(done) {
      subject().then(function (instance) {
        filesystem.saveFiles(instance, [file_1]).then(function (progressEvent) {
          const result = filesystem.removeFile(instance, file_1.name)
    ...
    it('promise resolves undefined', function(done) {
      subject().then(function (instance) {
        filesystem.saveFiles(instance, [file_1]).then(function (progressEvent) {
          filesystem.removeFile(instance, file_1.name).then(function(result) {
  ...
  describe('.removeFiles', function() {
    it('returns promise', function(done) {
      subject().then(function (instance) {
        filesystem.saveFiles(instance, [file_1, file_2]).then(function (progressEvent) {
          const result = filesystem.removeFiles(instance, [file_1.name, file_2.name])
    ...
    it('promise resolves list of undefineds', function(done) {
      subject().then(function (instance) {
        filesystem.saveFiles(instance, [file_1, file_2]).then(function (progressEvent) {
          filesystem.removeFiles(instance, [file_1.name, file_2.name]).then(function(result) {
